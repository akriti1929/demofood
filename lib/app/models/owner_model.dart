...
class OwnerModel {
  ...
  Timestamp? createdAt;
  bool? isVerified;
  List<VerifyRestaurantDocumentModel>? verifyDocument;
  ...
  OwnerModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['verifyDocument'] != null) {
      verifyDocument = <VerifyRestaurantDocumentModel>[];
      json['verifyDocument'].forEach((v) {
        verifyDocument!.add(VerifyRestaurantDocumentModel.fromJson(v));
      });
    }
  }
