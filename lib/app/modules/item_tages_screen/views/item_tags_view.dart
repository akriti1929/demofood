...
class ItemTagsView extends GetView {
  const ItemTagsView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetBuilder<ItemTagsController>(
        init: ItemTagsController(),
        builder: (controller) {
                                  ...
                                  : controller.driverCancellingReasonList.isEmpty
                                      ...
                                      : DataTable(
                                          ...
                                          columns: [
                                            ...
                                            CommonUI.dataColumnWidget(context,
                                                columnTitle: "Tag".tr, width: ResponsiveWidget.isMobile(context) ? 220 : MediaQuery.of(context).size.width * 0.40),
                                            CommonUI.dataColumnWidget(context,
                                          ...
                                          rows: controller.driverCancellingReasonList
                                              .map((reasonModel) => DataRow(cells: [
                                                    DataCell(TextCustom(title: "${controller.driverCancellingReasonList.indexWhere((element) => element == reasonModel) + 1}")),
...
class ReasonDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<ItemTagsController>(
      init: ItemTagsController(),
      builder: (controller) {
        return CustomDialog(
          ...
          widgetList: [
            Row(
              children: [
                Expanded(child: CustomTextFormField(hintText: "Enter Item Tag".tr, controller: controller.reasonController.value, title: "Item Tag *".tr)),
              ],
            ),
          ],
          bottomWidgetList: [
