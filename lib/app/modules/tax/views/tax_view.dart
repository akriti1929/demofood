                          ...
                          : DataTable(
                              ...
                              rows: controller.taxList
                                  .map((taxModel) => DataRow(cells: [
                                        ...
                                        DataCell(TextCustom(title: taxModel.isFix! ? "Fix".tr : "Percentage".tr)),
                                        DataCell(
                                          Transform.scale(
                                            scale: 0.8,
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: () {
                                                    ...
                                                    controller.selectedTaxType.value = taxModel.isFix == true ? "Fix".tr : "Percentage".tr;
                          ...
                          () => DropdownButtonFormField(
                            ...
                            items: countryList.map<DropdownMenuItem<String>>((String value) {
                              return DropdownMenuItem(
                                ...
                                child: Text(
                                  value.tr,
                                  style: TextStyle(fontFamily: FontFamily.regular, fontSize: 16, color: themeChange.isDarkTheme() ? AppThemeData.lynch200 : AppThemeData.lynch800),
                                ),
                              );
                            }).toList(),
                            decoration: Constant.DefaultInputDecoration(context),
