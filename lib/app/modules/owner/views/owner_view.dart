                                        ...
                                        children: [
                                                ...
                                                onChanged: (String? statusType) async {
                                                  ...
                                                  switch (statusType) {
                                                    case 'Last Month':
                                                      ...
                                                      await FireStoreUtils.countOwnersWithMonth(
                                            ...
                                            child: CustomTextFormField(
                                              ...
                                              onFieldSubmitted: (value) async {
                                                if (controller.isSearchEnable.value) {
                                                  await FireStoreUtils.countSearchOwner(controller.searchController.value.text, controller.selectedSearchTypeForData.value);
                                          ...
                                          CustomButtonWidget(
                                              ...
                                              onPress: () {
                                                ...
                                                showDialog(context: context, builder: (context) => const AddOwner());
                                              }),
                                          spaceW(),
                                          ContainerCustom(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  showDialog(
                                                      ...
                                                      builder: (context) => CustomDialog(
                                                            controller: controller,
                                                            title: "Owner Statement Download".tr,
                                                            widgetList: [
                                                              TextCustom(
                            ...
                            controller.isLoading.value
                                ...
                                : SingleChildScrollView(
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: controller.currentPageOwnerList.isEmpty
                                            ...
                                            : DataTable(
                                                ...
                                                columns: [
                                                  ...
                                                  CommonUI.dataColumnWidget(context,
                                                      columnTitle: "Phone Number".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.10),
                                                  CommonUI.dataColumnWidget(context,
                                                      columnTitle: "Created At".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.10),
                                                  CommonUI.dataColumnWidget(context,
                                                      columnTitle: "Status".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.04),
                                                  CommonUI.dataColumnWidget(context,
                                                      columnTitle: "Document Verify".tr,
                                                      width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.04),
                                                  CommonUI.dataColumnWidget(context,
                                                      columnTitle: "Action".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.08)
                                                ],
                                                rows: controller.currentPageOwnerList
                                                    .map((ownerModel) => DataRow(cells: [
                                                          DataCell(
                                                            Container(
                                                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                                              child: NetworkImageWidget(
                                                                imageUrl: '${ownerModel.profileImage}',
                                                                height: 37,
                                                                width: 37,
                                                              ),
                                                            ),
                                                          ...
                                                          DataCell(InkWell(
                                                              onTap: () async {
                                                                Get.toNamed("${Routes.OWNER_DETAIL_SCREEN}/${ownerModel.id}");
                                                              },
                                                              child: TextCustom(title: ownerModel.fullNameString()))),
                                                          DataCell(
                                                            TextCustom(
                                                              title: Constant.isDemo == true
                                                                  ? Constant.maskEmailNotShow(ownerModel.email)
                                                                  : (ownerModel.email == null || ownerModel.email!.isEmpty)
                                                                      ? "N/A"
                                                                      : ownerModel.email.toString(),
                                                            ),
                                                          ),
                                                          DataCell(TextCustom(
                                                            title: Constant.maskMobileNumber(
                                                                countryCode: ownerModel.countryCode.toString(), mobileNumber: ownerModel.phoneNumber.toString()),
                                                          )),
                                                          DataCell(TextCustom(title: Constant.timestampToDate(ownerModel.createdAt!))),
                                                          DataCell(
                                                            Transform.scale(
                                                              scale: 0.8,
                                                              child: CupertinoSwitch(
                                                                activeTrackColor: AppThemeData.primary500,
                                                                value: ownerModel.active ?? false,
                                                                onChanged: (value) async {
                                                                  if (Constant.isDemo) {
                                                                    DialogBox.demoDialogBox();
                                                                  } else {
                                                                    ownerModel.active = value;
                                                                    await FireStoreUtils.updateOwner(ownerModel);
                                                                    controller.getOwner();
                                                                  }
                                                                },
                                                              ),
                                                          ...
                                                          DataCell(
                                                            Transform.scale(
                                                              ...
                                                              child: CupertinoSwitch(
                                                                activeTrackColor: AppThemeData.primary500,
                                                                value: ownerModel.isVerified ?? false,
                                                                onChanged: (value) async {
                                                                  if (Constant.isDemo) {
                                                                    DialogBox.demoDialogBox();
                                                                  } else {
                                                                    ownerModel.isVerified = value;
                                                                    await FireStoreUtils.updateOwner(ownerModel);
                                                                    controller.getOwner();
                                                                  }
                                                                },
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    // controller.getArgument(ownerModel);
                                                                    showDialog(
                                                                        context: context,
                                                                ...
                                                                InkWell(
                                                                  onTap: () async {
                                                                    if (Constant.isDemo) {
                                                                      ...
                                                                      if (confirmDelete) {
                                                                        await controller.removeOwners(ownerModel);
                                                                        controller.getOwner();
                                                                      }
                                                                    }
                                                                  },
...
class AddOwner extends StatelessWidget {
  ...
  const AddOwner({super.key, this.ownerModel, this.isEditing = false});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    final controller = Get.put(OwnerController());
    if (isEditing == true && ownerModel != null) {
      controller.getArgument(ownerModel!);
    }
    return GetX<OwnerController>(builder: (_) {
      return CustomDialog(
        title: controller.isEditing.value == true ? "Edit Owner".tr : "Add Owner".tr,
                                  ...
                                  child: Center(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        spaceH(height: 16),
                                        TextCustom(
                                          title: "Upload the Owner Profile".tr,
                                          maxLine: 2,
            ...
            onPress: () {
              if (Constant.isDemo) {
                ...
                if (controller.firstNameController.value.text.isEmpty) {
                  ...
                  Navigator.pop(context);
                  controller.isEditing.value == true ? controller.updateOwner() : controller.addOwner();
                }
              }
            },
          ),
