                                          ...
                                          : DataTable(
                                              ...
                                              columns: [
                                                CommonUI.dataColumnWidget(context,
                                                    columnTitle: "Image".tr, width: 100),
                                                CommonUI.dataColumnWidget(context,
                                                    columnTitle: "Cuisine Name".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.18),
                                                CommonUI.dataColumnWidget(context,
                      ...
                      controller.isEditing.value == true
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        height: 0.18.sh,
                                        width: 0.30.sw,
                                        imageUrl: controller.cuisineFile.value.path.isEmpty ? controller.cuisineURL.value : controller.cuisineFile.value.path,
                                      ),
                                    ),
                                    Center(
                                      child: InkWell(
                                        onTap: () async {
                                          if (Constant.isDemo) {
                                            ...
                                            if (img != null) {
                                              ...
                                              controller.cuisineImageName.value.text = img.name;
                                              controller.cuisineFile.value = imageFile;
                                              controller.mimeType.value = "${img.mimeType}";
                                              controller.isImageUpdated.value = true;
                                            }
                                          }
                                        },
                                        child: controller.cuisineFile.value.path.isEmpty
                                            ? const Icon(
                                                Icons.add,
                          ...
                          : Padding(
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    if (controller.cuisineFile.value.path.isNotEmpty)
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(12),
                                        child: CachedNetworkImage(
                                          fit: BoxFit.contain,
                                          height: 0.18.sh,
                                          width: 0.30.sw,
                                          imageUrl: controller.cuisineFile.value.path,
                                        ),
                                      ),
                                    Center(
                                      child: InkWell(
                          ...
                          CustomButtonWidget(
                            ...
                            onPress: () {
                              if (Constant.isDemo) {
                                ...
                                if (controller.cuisineNameController.value.text != "" && controller.cuisineImageName.value.text.isNotEmpty) {
