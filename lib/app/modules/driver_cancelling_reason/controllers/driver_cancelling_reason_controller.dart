...
class DriverCancellingReasonController extends GetxController {
  RxString title = "Driver Cancelling Reason".tr.obs;
  ...
  Future<void> getData() async {
    isLoading(true);
    driverCancellingReasonList.value = await FireStoreUtils.getDriverCancellingReason();
    isLoading(false);
  }
  ...
  Future<void> addReason() async {
    ...
    await FireStoreUtils.addDriverCancellingReason(driverCancellingReasonList);
    setDefaultData();
    isLoading.value = false;
  }
  ...
  Future<void> removeReason(String reason) async {
    ...
    await FirebaseFirestore.instance
        ...
        .set(<String, List<String>>{"reasons": driverCancellingReasonList}).then((value) {
      ShowToastDialog.successToast("Driver Cancelling Reason Deleted...!".tr);
    }).catchError((error) {
