                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<CategoryModel>(
                                ...
                                style:
                                    TextStyle(fontFamily: FontFamily.medium, color: themeChange.isDarkTheme() ? AppThemeData.primaryWhite : AppThemeData.textBlack, fontSize: 14),
                                decoration: Constant.DefaultInputDecoration(context),
                              ),
                            ],
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<SubCategoryModel>(
                                ...
                                style:
                                    TextStyle(color: themeChange.isDarkTheme() ? AppThemeData.primaryWhite : AppThemeData.textBlack, fontFamily: FontFamily.medium, fontSize: 14),
                                decoration: Constant.DefaultInputDecoration(context),
                              )
                            ],
                          ),
                                      ...
                                      CustomButtonWidget(
                                        ...
                                        onPress: () {
                                          if (controller.optionNameController.value.text.isEmpty) {
                                            ShowToastDialog.errorToast("Please enter option name".tr);
                                          } else if (controller.optionPriceController.value.text.isEmpty) {
                                            ShowToastDialog.errorToast("Please enter option price".tr);
                                          } else {
                  ...
                  onPress: () {
                    if (Constant.isDemo) {
                      ...
                      if (controller.itemNameController.value.text.isNotEmpty &&
                        ...
                        ShowToastDialog.errorToast("Please Enter Valid Details..".tr);
                      }
                    }
                  },
                ),
