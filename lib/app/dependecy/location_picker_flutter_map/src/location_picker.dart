// ignore_for_file: depend_on_referenced_packages, unintended_html_in_doc_comment, strict_top_level_inference
...
class _FlutterLocationPickerState extends State<FlutterLocationPicker> with TickerProviderStateMixin {
  ...
  Future<PickedData> pickData(LatLong center) async {
    ...
    int roundedZoom = widget.nominatimZoomLevel ?? ((isLoading || _animationController.isAnimating) ? 18 : min(_mapController.camera.zoom.round(), 18));
    // String url =
