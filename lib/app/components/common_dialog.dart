...
class _CommonDialogState extends State<CommonDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIconColor: AppThemeData.borderGrey,
                fillColor: AppThemeData.lightGrey01,
                filled: true,
                hintText: widget.hintText,
                prefix: widget.prefix,
                hintStyle: const TextStyle(fontFamily: FontFamily.regular, color: AppThemeData.green800),
                ...
                errorBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(50),
                  borderSide: const BorderSide(width: 0.5, color: AppThemeData.red400),
                ),
              ),
            ),
          ],
      ...
      actions: <Widget>[
        CustomButtonWidget(
            buttonColor: AppThemeData.borderGrey,
            title: widget.negativeButtonLabel,
            width: 150,
            onPress: () async {
        ...
        CustomButtonWidget(
            title: widget.positiveButtonLabel,
            width: 150,
            onPress: () async {
              log('===>');
