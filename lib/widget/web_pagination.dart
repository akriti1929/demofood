...
class _PageControlButtonState extends State<_PageControlButton> {
  Color normalTextColor =  AppThemeData.primary500;
...
class __PageItemState extends State<_PageItem> {
  ...
  Color normalHighlightColor =  AppThemeData.primary500;
  // Color normalHighlightColor =  AppThemeData.primary500;
    ...
    return InkWell(
        onHover: (b) {
          ...
          setState(() {
            ...
            highlightColor = b ?  AppThemeData.primary500 : normalHighlightColor;
          });
        },
        onTap: () {
...
class _ItemContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: themeChange.isDarkTheme() ? AppThemeData.lynch950  : backgroundColor, borderRadius: BorderRadius.circular(4)),
      child: child,
    );
  }
}