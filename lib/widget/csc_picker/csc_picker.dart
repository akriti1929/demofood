// ignore_for_file: unnecessary_null_comparison, prefer_typing_uninitialized_variables, prefer_interpolation_to_compose_strings, constant_identifier_names, empty_catches, strict_top_level_inference

library;


import 'package:admin_panel/widget/csc_picker/dropdown_with_search.dart';
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Widget countryDropdown() {
    return DropdownWithSearch(
      selectedItemPadding: paddingEdgeInsets(horizontal: 8,vertical: 6),
