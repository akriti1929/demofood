        ...
        onTap: () {
          showDialog(
              ...
              builder: (context) => Theme(
                 data:  Theme.of(context).copyWith(dialogTheme: const DialogThemeData(backgroundColor: AppThemeData.lynch800)),
                child: SearchDialog(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Icon(Icons.keyboard_arrow_down_rounded,color: AppThemeData.lynch500,)
              ],
            ),
          ),
        ),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(color: AppThemeData.lynch500),
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.all(
                        widget.searchInputRadius != null
                            ? Radius.circular(widget.searchInputRadius!)
                            : const Radius.circular(5)),
                    borderSide: const BorderSide(color: AppThemeData.lynch700),
                  ),
                ),
                style: widget.itemStyle ?? const TextStyle(fontSize: 14,color: AppThemeData.lynch50),
