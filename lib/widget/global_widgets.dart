...
Container divider(context, {Color? color, double height = 1}) {
  ...
  return Container(height: height, color: color ?? (themeChange.isDarkTheme() ? AppThemeData.lynch950 : AppThemeData.lynch50));
}
              ...
              Expanded(
                ...
                child: InkWell(
                  ...
                  child: Row(
                    children: [
                      parameter == radioOne
                          ? const Icon(Icons.radio_button_checked, color: AppThemeData.primary500, size: 18)
                          : Icon(Icons.circle_outlined, color: themeChange.isDarkTheme() ? AppThemeData.lynch100 : AppThemeData.lynch950, size: 18),
                      spaceW(width: 4),
